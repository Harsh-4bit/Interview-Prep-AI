                ...
                code({node, className, children, ...props}){
                    ...
                    return !isInline ? (
                        ...
                        />
                            ...
                            <code className='px-1 py-0.5 bg-gray-100 rounded text-sm' {...props}>{children}</code>
                        )
...
function CodeBlock({code, language}){
    ...
    return  <div className='relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200'>
                <div className='flex items-center justify-between px-2 py-4 bg-gray-100 border-b border-gray-200'>
                    ...
                    <button className='text-gray-500 hover:text-gray-700 focus:outline-none relative group' onClick={copyCode} aria-label='Copy code'>{copied ? (
