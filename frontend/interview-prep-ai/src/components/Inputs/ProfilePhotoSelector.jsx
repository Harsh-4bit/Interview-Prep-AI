        ...
        <div className='flex justify-center mb-6'>
            ...
            {!image ? (
                ...
                <div className='relative'>
                    ...
                    <button className="w-8 h-8 flex justify-center items-center bg-red-500 text-white rounded-full absolute -bottom-1 -right-1 cursor-pointer" onClick={handleRemoveImage}>
                        <LuTrash/>
                    </button>
                </div>
                )}
